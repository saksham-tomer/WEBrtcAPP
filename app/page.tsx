...
//   };
//
//   // Funetion to handle receiving answer from remote peer
...
const SERVER: String = process.env.SERVER || "http://localhost:4000"

const ws:Socket = io(SERVER,{
         reconnectionDelayMax: 10000,    
})
...
export default function Page(){
  ...
  return (
  <div>
    <button onClick={createRoom} className="p-2 bg-pink-500 rounded-2xl">Join Meeting</button>
  </div>
  )
}
